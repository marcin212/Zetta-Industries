...
public class RFMeterBlock extends BasicBlockContainer {
	...
	// ForgeDirection side)
	// {
	// return RenderUtils.FORGE_DIRECTIONS[world.getBlockMetadata(x, y, z)] ==
	// side;
	// }
	//
	// @Override
	...
	//
	// @Override
	// public boolean shouldSideBeRendered(IBlockAccess p_149646_1_, int
	// p_149646_2_, int p_149646_3_, int p_149646_4_, int p_149646_5_) {
	// return true;
	// }
	//
	// @Override
	...
	// int whichDirectionFacing = MathHelper.floor_double((double)
	// (par5EntityLivingBase.rotationYaw * 4.0F / 360.0F) + 2.5D) & 3;
	...
	// ArrayList<ItemStack> items = getDrops(world, x, y, z,
	...
	// RFMeterTileEntity tile = (RFMeterTileEntity) world.getTileEntity(x, y,
	// z);
	// if (tile != null)
	// {
