...
public class ECatalogueMod implements IMod{
	...
	public void postInit() {
	    ...
	    ItemStack stamp = ForestryItem.stamps.getItemStack(1, 0);
	    ItemStack bronze = ForestryItem.ingotBronze.getItemStack(1);
	    ItemStack catalogue = ForestryItem.catalogue.getItemStack(1);
